...
public class YarConcurrentClientTest extends TestCase {
    ...
    public void testLoop() throws Exception {
        ...
        YarConcurrentClient.call(new YarConcurrentCallStack(uri,"support",new Object[]{1,2},transport,packagerName,new callback()));
        YarConcurrentClient.call(new YarConcurrentCallStack(uri,"post",new Object[]{1,2},transport,packagerName,new callback()));
