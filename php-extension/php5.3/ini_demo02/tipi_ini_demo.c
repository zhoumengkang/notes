 ...
 */
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("tipi_ini_demo.global_value",      "42", PHP_INI_SYSTEM, OnUpdateLong, global_value, zend_tipi_ini_demo_globals, tipi_ini_demo_globals)
PHP_INI_END()
/* }}} */
...
{
	tipi_ini_demo_globals->global_value = 90;
}
/* }}} */
...
/* {{{ proto string get_demo_init_value(string init_key)
    */
